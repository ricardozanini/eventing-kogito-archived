...
import (
	...
	samplesource "knative.dev/eventing-kogito/pkg/client/injection/reconciler/kogito/v1alpha1/kogitosource"
)
...
func newReconciledNormal(namespace, name string) reconciler.Event {
	return reconciler.NewEvent(v1.EventTypeNormal, "SampleSourceReconciled", "KogitoSource reconciled: \"%s/%s\"", namespace, name)
}

// Reconciler implements controller.Reconciler for KogitoSource resources.
...
//var _ kogitosource.Finalizer = (*Reconciler)(nil)
...
//var _ kogitosource.ReadOnlyInterface = (*Reconciler)(nil)
...
//var _ kogitosource.ReadOnlyFinalizer = (*Reconciler)(nil)

// ReconcileKind implements Interface.ReconcileKind.
func (r *Reconciler) ReconcileKind(ctx context.Context, o *v1alpha1.KogitoSource) reconciler.Event {
...
//func (r *Reconciler) FinalizeKind(ctx context.Context, o *v1alpha1.KogitoSource) reconciler.Event {
//	// TODO: add custom finalization logic here.
//	return nil
//}

// Optionally, use ObserveKind to observe the resource when we are not the leader.
// func (r *Reconciler) ObserveKind(ctx context.Context, o *v1alpha1.KogitoSource) reconciler.Event {
...
//func (r *Reconciler) ObserveFinalizeKind(ctx context.Context, o *v1alpha1.KogitoSource) reconciler.Event {
// 	// TODO: add custom observation logic here.
//	return nil
//}
